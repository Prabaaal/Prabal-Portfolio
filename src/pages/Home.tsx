...
const Home = () => {
  ...
  return (
    <motion.div
      className="flex flex-col lg:flex-row gap-10 pb-10"
      initial="hidden"
    ...
    >
        ...
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <motion.div variants={itemVariants}>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {['JavaScript', 'React', 'Node.js', 'Python', 'C++', 'Three.js'].map((tech) => (
                <div 
                  key={tech}
                  className="flex items-center px-4 py-2 glass-card rounded-lg"
                >
      ...
      >
        <div className="relative">
          <motion.div
            className="absolute inset-0 -z-10 from-primary/20 to-transparent rounded-full blur-3xl"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.6 }}
